...
FLUENTPATCH.SetWindow("Title", "Steal a Brainrot")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/whodunitwww/noxhelpers/refs/heads/main/neox/steal-a-brainrot.lua", true))()
