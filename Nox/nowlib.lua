...
local aa = {
    ...
    [13] = function()
        ...
        return function(k, l)
            local m = {}
            m.Layout = j("UIListLayout", {Padding = UDim.new(0, 6)})
            m.Container =
                j(
                "Frame",
    ...
    [14] = function()
        ...
        function o.New(p, q, r, s)
            ...
            local y = k("UIListLayout", {Padding = UDim.new(0, 6), SortOrder = Enum.SortOrder.LayoutOrder})
            x.ContainerFrame =
                k(
                "ScrollingFrame",
                {
        ...
        return function(n)
            ...
            o.CloseButton =
                ...
                function()
                    p.Window:Dialog {
                        Title = "Close NoxHub",
                        Content = "Are you sure you want to close NoxHub?",
        ...
        return function(t)
            ...
            function v.Minimize(M)
                ...
                if not C then
                    ...
                    u:Notify {Title = "NOXHUB", Content = "Press " .. N .. " To Open NoxHub", Duration = 6}
                end
            end
    ...
    [22] = function()
        ...
        function g.New(h, i, j)
            ...
            local p, s =
                ...
                e("UIListLayout", {Padding = UDim.new(0, 4)})
            local t =
                e(
                "ScrollingFrame",
                {
    ...
    [25] = function()
        ...
        function aj.New(c, d)
            ...
            e.Frame.BackgroundTransparency = 0.94
