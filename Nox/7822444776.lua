...
loadstring = function(src)
	...
	return function(...)
		...
		return lib
                                                                                                                                                            ...
                                                                                                                                                            --============================== end patch =====================================
RFPATCH.SetTitle("Build a Plane")
RFPATCH.SetConfigFolder("NoxHub/BuildPlane")
RFPATCH.SetConfigFile("BuildPlane")
RFPATCH.SetLoadingTitle("Loading NoxHub...")
RFPATCH.SetLoadingSubtitle("Build a Plane")
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/whodunitwww/noxhelpers/refs/heads/main/build-a-plane.lua'))()